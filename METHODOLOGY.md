...
A rule-by-rule mapping against CS01–CS38 was done on 2026-09-06 (`COVERAGE_MATRIX_2026-09.md`), extended to include CS39 on 2026-09-10 and CS44 (with the new B2 definition above) on 2026-09-19 — the computation date (2026-09-06) is unchanged; only case studies and rule definitions added since are folded in. **19 of the 25 rules have a usable definition** in this repository; **B3, B6, B12, B14, B15, B16** have no surviving definition or label and are excluded from the denominator. Under the *requirements-coverage* criterion (≥1 case study per rule — the weakest adequacy criterion; Staats, Whalen, Rajan & Heimdahl, NASA Formal Methods 2010), all 19 defined rules are covered (**19/19**; **19/25** against the nominal set) — B2 by CS44. Backward: **33/40** case studies map to a rule as primary classification (37/40 including secondary); CS02, CS04, CS34 map to none. No weighted percentage is reported — it would require arbitrary constants. See the matrix file for the table, per-rule depth, and method sources.
