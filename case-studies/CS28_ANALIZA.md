...
**Case Study:** CS28 (przydzielony — kolejny po CS27)
...
Analogicznie do CS24 (KNOWING ≠ DOING) — model ZBIÓR własną historię sesji, ale jej nie używa do weryfikacji zarzutów.
