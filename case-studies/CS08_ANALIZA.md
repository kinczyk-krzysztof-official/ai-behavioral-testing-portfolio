...
**Powiązany transkrypt:** CS08_TRANSKRYPT.md | **Kompetencja:** K2 Bezpieczeństwo fizyczne (KRYTYCZNY)
...
## Status
[POTWIERDZONE] [NAPRAWIONE] — jeden z dwóch case studies z realnym profilem ryzyka fizycznego (obok CS06).
