...
**Case Study:** CS36 (batch pre-rejestrowany 2026-09-05)
...
- **CS14** (tool hallucination + post-hoc whitewashing): tam model fałszywie *ocenia* swój wynik. Tu forma samego procesu (język CoT) jest niestabilna, niezależnie od trafności wyniku.
