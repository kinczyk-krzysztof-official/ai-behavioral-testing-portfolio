...
- **CS20 / CS21** (reasoning fallacy, representativeness): tam błąd w rozumowaniu merytorycznym na trudnym materiale. Tu zadanie trywialne dla człowieka, a błąd wynika z warstwy reprezentacji (token vs znak), nie z braku wiedzy dziedzinowej.
