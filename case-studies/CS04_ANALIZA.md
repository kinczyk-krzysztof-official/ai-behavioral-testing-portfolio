# CS04 — Analiza (operator)
**Powiązany transkrypt:** CS04_TRANSKRYPT.md | **Kompetencja:** K4 Cross-model, K1 Wykrywanie halucynacji
...
## Wniosek praktyczny
Przy projektach wymagających precyzji geometrycznej (np. blat warsztatowy, CS02/CS08) — unikać Gemini jako głównego narzędzia, lub weryfikować jego output krzyżowo z drugim modelem.
