# CS06 — Transkrypt źródłowy (rekonstrukcja z raportu)
**Model:** Gemini (Google) Live, transmisja wideo na żywo | **Okres:** 2025 | **Czas trwania:** ~15 minut

> Warstwa surowa/opisowa. Analiza w CS06_ANALIZA.md. Oryginalna sesja wideo nie jest dostępna jako tekstowy transkrypt — poniższy zapis to udokumentowana rekonstrukcja przebiegu zdarzenia sporządzona bezpośrednio po incydencie.
