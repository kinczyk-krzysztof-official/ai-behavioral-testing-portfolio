...
**Przypadek:** CS29 — Blokada orientacji ekranu odblokowywana podczas testów na urządzeniu; nieudokumentowana, potem błędnie zawężona przez trzy kolejne wystąpienia, ostatecznie wyjaśniona systematycznym śledztwem 14.08.2026.
...
- **Przyczyna źródłowa (14.08):** eksperymentem kontrolowanym — 6 prób na Mi 10T Pro + 2 potwierdzające na Oppo A31, timestampy co do milisekundy, oraz zweryfikowana w kodzie źródłowym AOSP (`MonkeyRotationEvent.java`). Pełna analiza techniczna: `CS28_ANALIZA.md`.
