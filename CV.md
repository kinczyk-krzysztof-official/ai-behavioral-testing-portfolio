...
- IT/hardware support — HP/iQor (technical support)
- Automotive dealer systems — BMW/Incadea
- Independent electronics and DIY engineering (home workshop, custom builds)
- 12 months independent AI behavioral testing (this portfolio)
...
Everything here was self-documented and self-reviewed — that's disclosed openly in `METHODOLOGY.md`, not hidden. What I'm offering is not a finished, externally validated evaluation, but twelve months of demonstrated, specific, checkable pattern-finding — the raw skill a structured evaluation role would put to use.
